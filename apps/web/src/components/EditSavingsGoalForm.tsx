...
export function EditSavingsGoalForm({
  ...
  // Form state - pre-fill with existing goal data
  const [name, setName] = useState(goal.name)
  const [targetAmount, setTargetAmount] = useState(formatCentsToCurrency(goal.targetAmount))
  const [currentBalance, setCurrentBalance] = useState(formatCentsToCurrency(goal.currentBalance))
  ...
  return (
    <form
      ...
      className="space-y-4"
      noValidate
      data-testid="edit-savings-goal-form"
    >
      {/* Name Field */}
      <div>
        <label
          htmlFor="edit-savings-goal-name"
          className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
        >
          Savings Goal Name *
        </label>
        <input
          id="edit-savings-goal-name"
          type="text"
          value={name}
          ...
          aria-describedby={hasFieldError('name') ? 'edit-savings-goal-name-error' : undefined}
          data-testid="edit-savings-goal-name-input"
        />
        {hasFieldError('name') && (
          <p
            id="edit-savings-goal-name-error"
      ...
      <div>
        <label
          htmlFor="edit-savings-goal-target-amount"
          className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
        >
          Target Amount *
        </label>
        <div className="relative">
          ...
          <input
            id="edit-savings-goal-target-amount"
            type="text"
            inputMode="decimal"
            value={targetAmount}
        ...
        {hasFieldError('targetAmount') && (
          <p
            id="edit-savings-goal-target-amount-error"
            className="mt-1 text-sm text-red-600 dark:text-red-400"
            role="alert"
          >
      ...
      <div>
        <label
          htmlFor="edit-savings-goal-current-balance"
          className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
        >
          Current Balance *
        </label>
        <div className="relative">
          ...
          <input
            id="edit-savings-goal-current-balance"
            type="text"
            inputMode="decimal"
        ...
        {hasFieldError('currentBalance') && (
          <p
            id="edit-savings-goal-current-balance-error"
            className="mt-1 text-sm text-red-600 dark:text-red-400"
            role="alert"
          >
        ...
        {currentBalanceCents > 0 && !hasFieldError('currentBalance') && (
          <p
            id="edit-savings-goal-current-balance-help"
      ...
      <div className="flex gap-3 pt-2">
        <button
          ...
          data-testid="edit-savings-goal-submit"
        >
          {isSubmitting ? (
            <>
        ...
        <button
          ...
          data-testid="edit-savings-goal-cancel"
        >
          Cancel
        </button>
      </div>
