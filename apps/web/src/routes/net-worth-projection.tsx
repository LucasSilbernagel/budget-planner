...
import {
  NetWorthChart,
  hasInsufficientData as checkInsufficientData,
} from '../components/net-worth/net-worth-chart'
import {
  DEFAULT_SCENARIOS,
  type Scenario,
  ScenarioControls,
} from '../components/net-worth/scenario-controls'
...
export function NetWorthProjectionPage() {
  ...
  const _hookIsCalculating = netWorth.isLoading
  ...
  const _visibleScenarios = useMemo(() => {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <header className="mb-12">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h1 className="text-4xl font-bold text-gray-900">Net Worth Projection</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              {scenariosWithProjection.length > 0 && (
                <NetWorthChart scenarios={scenariosWithProjection} height={450} showBrush={true} />
              )}
            </div>
          </div>
            ...
            <div className="mt-8">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <p className="text-yellow-700 text-sm">
                  ⚠️ All scenarios have insufficient data. Please adjust the parameters to see
                  projections.
                </p>
              </div>
            </div>
          ...
          <div className="mt-12 bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-gray-700 mb-3">Multiple Scenarios</h3>
                <p className="text-gray-600 mb-3">
                  Create multiple scenarios to compare different financial futures. Each scenario
                  can have its own assumptions about returns, growth, and time horizons.
                </p>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              ...
              <ul className="space-y-2 text-gray-600">
                <li>
                  • Use the "Sync Time Horizon" button to align all scenarios to the same period
                </li>
                ...
                <li>
                  • Rename scenarios to reflect their purpose (e.g., "Early Retirement", "College
                  Fund")
                </li>
              </ul>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500 mb-4">Related Financial Tools</p>
